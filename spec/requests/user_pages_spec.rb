...
describe "UserPages" do
  ...
  describe "profile page" do
    ...
    let!(:m2) { FactoryGirl.create(:micropost, content: "asdf skdljkasd lksadfkasld lsfjjkwoiucx", user: user)}
  ...
  describe "edit" do
    ...
    describe "with invalid information" do
      ...
      it { should have_selector("div.alert.alert-error", text:"Update failed") }
    end
